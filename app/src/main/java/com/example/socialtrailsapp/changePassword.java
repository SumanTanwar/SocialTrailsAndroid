...
public class changePassword extends BottomMenuActivity {
                    ...
                    new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                                ...
                                currentUser.updatePassword(newpwd).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(changePassword.this, "Password successfully changed! Sign in using new password", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(changePassword.this, "Failed to change password! Please try again after sometime ", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
                            else
                            {
                                ...
                                Toast.makeText(changePassword.this, "Authentication failed. Verify your current password.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
            );
